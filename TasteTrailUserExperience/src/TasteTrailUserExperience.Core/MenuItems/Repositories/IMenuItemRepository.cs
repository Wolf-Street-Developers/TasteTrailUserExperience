...
IGetByIdAsync<MenuItem?, int>, IGetAsNoTrackingAsync<MenuItem?, int>, IPutAsync<MenuItem, int?>, Common.Repositories.Base.IIncrementLikesAsync<MenuItem, int?>, Common.Repositories.Base.IDecrementLikesAsync<MenuItem, int?> 
{
